    ...
    useEffect( () => {   
      ...
      console.log("object: ", data);
        ...
        return(
          ...
          <Text style={{fontSize:17,marginTop:10,marginLeft:5,fontWeight:'bold',color:'#000'}}>TRENDING OF BOOK</Text>
          <TouchableOpacity onPress={()=> navigation.navigate('AddListBook')}>
